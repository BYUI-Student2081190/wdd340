...
-- NOTE: This table will be used to hold employee information
-- then it will be linked to the account table through account_ids
-- where the account_type is == to Employee
...
(
     ...
     employee_shiftstart character varying NOT NULL,
     employee_shiftend character varying NOT NULL,
     employee_shiftdays character varying NOT NULL,
     account_id integer NOT NULL,
     CONSTRAINT employee_pkey PRIMARY KEY (employee_id)
);

-- Create relationship between `account` and `employee` tables
